...
public class DealExcelInfoJ {
	...
	public void readExcel(String filePath) throws Exception {
		...
		// FileInputStream("J://DHL/SSD模板.xls");
		FileInputStream fileInputStream = new FileInputStream(filePath);

		// 获取Excel文件对象
		rwb = Workbook.getWorkbook(fileInputStream);
	...
	public static void main(String[] args) throws Exception {
		DealExcelInfoJ readExcelInfoJ = new DealExcelInfoJ();
//		readExcelInfoJ.readExcel("J://DHL/SSD模板.xls");
		readExcelInfoJ.writeExcel();
	}
}
